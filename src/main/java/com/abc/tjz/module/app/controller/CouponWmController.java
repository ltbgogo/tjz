...
import com.abc.tjz.module.app.dto.CouponWmCondiDto;
...
@RestController
@RequestMapping("/action/app/couponwm")
public class CouponWmController extends AbstractController {
    ...
    public ResultDto<Set<Category>> getQuickEntries() {
        return ResultDto.succeed("", rf.getCategoryRepo().findOne("couponwm").getChildren());
    }
    ...
    public ResultDto<Page<CouponWm>> getCoupons(CouponWmCondiDto condi,
        ...
        Page<CouponWm> page = rf.getCouponWmRepo().findAll(condi.toSpecification(), pageable);
