...
<div id="id_actions">
    ...
    <a class="btn btn-primary btn-md" href="${app.actionPath}/adm/coupontb/showEdit" role="button">添加</a>
...
<form id="id_form">
    <table id="id_list" class="table table-striped table-hover">
        ...
        <tr v-for="coupon in coupons">
            ...
            <td><a v-bind:href="'${app.actionPath}/adm/coupontb/showEdit?id=' + coupon.id + '&jumpUrl=' + $common.generateJumpUrl()">{{coupon.id}}</a></td>
...
<!-- 分页 -->
<div id="id_page">
    <v-page href="${app.actionPath}/adm/coupontb/showIndex?" v-bind:total-pages="totalPages"></v-page>
</div>
