...
$(function () {
    ...
    var categoryId = $common.getUrlParam("categoryId", "couponwmelm");
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            gotoDetail: function (coupon) {
                location.href = actionPath + "/app/couponwm/showDetail?couponId=" + coupon.id;
            },
            //显示指定类型券
            showIndex: function (entry) {
                location.href = actionPath + "/app/couponwm/showIndex?categoryId=" + entry.id;
            }
        }
    });
     ...
     * 加载快速入口
     */
    $.get(actionPath + "/app/couponwm/getQuickEntries", function(r) {
    ...
    function loadCoupons() {
        ...
        $.get(actionPath + "/app/couponwm/getCoupons?page=" + page, {categoryId: categoryId}, function(r) {
