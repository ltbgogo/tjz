...
<div id="id_quick_entries">
    <a class="cls_quick_entry" v-for="entry in quickEntries" v-bind:href="'${app.actionPath}/coupontb/showList?categoryId=' + entry.id">
        <span>
            <img :src="'${app.dynamicResPath}/coupontb/entry/' + entry.second + '.png'">
